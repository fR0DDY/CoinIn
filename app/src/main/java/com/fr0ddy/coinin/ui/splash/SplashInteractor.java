...
public class SplashInteractor extends BaseInteractor
    ...
    public Observable<List<Long>> saveDefaultExchangeFees() {
        ...
        ExchangeFees koinexTRXTFees = new ExchangeFees(111, KOINEX_ID, "TRX", 0.0025, 0.0, 60);
        ...
        ExchangeFees bitBnsSIAFees = new ExchangeFees(104, BITBNS_ID, "SIA", 0.0025, 0.0025, 1);
        ...
        ExchangeFees oxybitFees9 = new ExchangeFees(70, OXYBIT_ID, "XMR", 0.0, 0.0, 0.04);
        ExchangeFees oxybitFees10 = new ExchangeFees(71, OXYBIT_ID, "TRX", 0.0, 0.0, 112);
        ExchangeFees oxybitFees11 = new ExchangeFees(72, OXYBIT_ID, "VET", 0.0, 0.0, 1);
        ExchangeFees oxybitFees12 = new ExchangeFees(73, OXYBIT_ID, "OMG", 0.0, 0.0, 0.1);
        ...
        ExchangeFees oxybitFees17 = new ExchangeFees(78, OXYBIT_ID, "BAT", 0.0, 0.0, 5);
        ExchangeFees oxybitFees18 = new ExchangeFees(79, OXYBIT_ID, "GNT", 0.0, 0.0, 5);
        ExchangeFees oxybitFees19 = new ExchangeFees(80, OXYBIT_ID, "KNC", 0.0, 0.0, 2);
        ExchangeFees oxybitFees20 = new ExchangeFees(81, OXYBIT_ID, "FUN", 0.0, 0.0, 80);
        ExchangeFees oxybitFees21 = new ExchangeFees(82, OXYBIT_ID, "SALT", 0.0, 0.0, 2);
        ExchangeFees oxybitFees22 = new ExchangeFees(83, OXYBIT_ID, "BNT", 0.0, 0.0, 1);
        ExchangeFees oxybitFees23 = new ExchangeFees(84, OXYBIT_ID, "REQ", 0.0, 0.0, 10);
        ...
        ExchangeFees oxybitFees26 = new ExchangeFees(87, OXYBIT_ID, "ICN", 0.0, 0.0, 2);
        ExchangeFees oxybitFees27 = new ExchangeFees(88, OXYBIT_ID, "POE", 0.0, 0.0, 90);
        ExchangeFees oxybitFees28 = new ExchangeFees(89, OXYBIT_ID, "CVC", 0.0, 0.0, 10);
        ...
        ExchangeFees oxybitFees31 = new ExchangeFees(92, OXYBIT_ID, "ANT", 0.0, 0.0, 1);
