...
public class SplashInteractor extends BaseInteractor
    ...
    public Observable<List<Long>> saveDefaultExchangeFees() {
        ...
        ExchangeFees coindeltaUSDTFees = new ExchangeFees(326, COINDELTA_ID, "USDT", 0.0015, 0.0015, 3);
        ...
        ExchangeFees unocoinFees4 = new ExchangeFees(160, UNOCOIN_ID, "BCH", 0.00708, 0.1, 0.0001);
