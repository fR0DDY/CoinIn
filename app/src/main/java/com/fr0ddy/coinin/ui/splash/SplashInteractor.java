...
public class SplashInteractor extends BaseInteractor
    ...
    public Observable<List<Long>> saveDefaultExchanges() {
        ...
        List<Exchange> exchanges = Arrays.asList(koinex, throughbit, zebpay, coinome, buyUcoin, coindelta, pocketBits, coinsecure, bitbns, oxybit, coinslab, unocoin, wazirX, koinOk);
