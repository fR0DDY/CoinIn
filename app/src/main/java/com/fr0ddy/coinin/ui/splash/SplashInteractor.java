...
public class SplashInteractor extends BaseInteractor
    ...
    public Observable<List<Long>> saveDefaultExchangeFees() {
        ...
        ExchangeFees koinexREQFees = new ExchangeFees(59, KOINEX_ID, "REQ", 0.0015, 0.0015, 15);
        ExchangeFees koinexZRXFees = new ExchangeFees(93, KOINEX_ID, "ZRX", 0.0015, 0.0015, 5);
        ExchangeFees koinexAEFees = new ExchangeFees(99, KOINEX_ID, "AE", 0.0015, 0.0015, 2);
        ExchangeFees koinexBATFees = new ExchangeFees(100, KOINEX_ID, "BAT", 0.0015, 0.0015, 10);
        ExchangeFees koinexGNTFees = new ExchangeFees(101, KOINEX_ID, "GNT", 0.0015, 0.0015, 10);
        ExchangeFees koinexTRXFees = new ExchangeFees(111, KOINEX_ID, "TRX", 0.0015, 0.0015, 60);
        ...
        ExchangeFees koinexAIONFees = new ExchangeFees(138, KOINEX_ID, "AION", 0.0015, 0.0015, 1.5);
        ExchangeFees koinexNCASHFees = new ExchangeFees(139, KOINEX_ID, "NCASH", 0.0015, 0.0015, 120);
        ExchangeFees koinexEOSFees = new ExchangeFees(146, KOINEX_ID, "EOS", 0.0015, 0.0015, 0.4);
        ExchangeFees koinexNANOFees = new ExchangeFees(147, KOINEX_ID, "NANO", 0.0015, 0.0015, 0.05);
        ExchangeFees koinexONTFees = new ExchangeFees(196, KOINEX_ID, "ONT", 0.0015, 0.0015, 0.0);
        ExchangeFees koinexZILFees = new ExchangeFees(197, KOINEX_ID, "ZIL", 0.0015, 0.0015, 40);
        ExchangeFees koinexIOSTFees = new ExchangeFees(206, KOINEX_ID, "IOST", 0.0015, 0.0015, 85);
        ExchangeFees koinexZCOFees = new ExchangeFees(208, KOINEX_ID, "ZCO", 0.0015, 0.0015, 50);
        ExchangeFees koinexPOLYFees = new ExchangeFees(209, KOINEX_ID, "POLY", 0.0015, 0.0015, 5);
        ExchangeFees koinexAELFFees = new ExchangeFees(227, KOINEX_ID, "AELF", 0.0015, 0.0015, 3.5);
        ExchangeFees koinexCMTFees = new ExchangeFees(238, KOINEX_ID, "CMT", 0.0015, 0.0015, 9);
        ExchangeFees koinexACTFees = new ExchangeFees(259, KOINEX_ID, "ACT", 0.0015, 0.0015, 0.2);
        ExchangeFees koinexSNTFees = new ExchangeFees(280, KOINEX_ID, "SNT", 0.0015, 0.0015, 30);
        ExchangeFees koinexREPFees = new ExchangeFees(293, KOINEX_ID, "REP", 0.0015, 0.0015, 0.1);
        ExchangeFees koinexQKCFees = new ExchangeFees(295, KOINEX_ID, "QKC", 0.0015, 0.0015, 15);
        ...
        ExchangeFees zebpayBTCFees = new ExchangeFees(8, ZEBPAY_ID, "BTC", 0.00295, 0.00295, 0.0005);
        ExchangeFees zebpayBCHFees = new ExchangeFees(28, ZEBPAY_ID, "BCH", 0.00295, 0.00295, 0.001);
        ExchangeFees zebpayLTCFees = new ExchangeFees(49, ZEBPAY_ID, "LTC", 0.00295, 0.00295, 0.006);
        ExchangeFees zebpayXRPFees = new ExchangeFees(50, ZEBPAY_ID, "XRP", 0.00295, 0.00295, 0.25);
        ExchangeFees zebpayETHFees = new ExchangeFees(60, ZEBPAY_ID, "ETH", 0.00295, 0.00295, 0.01);
        ExchangeFees zebpayEOSFees = new ExchangeFees(194, ZEBPAY_ID, "EOS", 0.00295, 0.00295, 0.4);
        ExchangeFees zebpayOMGFees = new ExchangeFees(195, ZEBPAY_ID, "OMG", 0.00295, 0.00295, 0.2);
        ExchangeFees zebpayTRXFees = new ExchangeFees(199, ZEBPAY_ID, "TRX", 0.00295, 0.00295, 60);
        ExchangeFees zebpayZILFees = new ExchangeFees(283, ZEBPAY_ID, "ZIL", 0.00295, 0.00295, 2);
        ExchangeFees zebpayREPFees = new ExchangeFees(284, ZEBPAY_ID, "REP", 0.00295, 0.00295, 0.05);
        ExchangeFees zebpayZRXFees = new ExchangeFees(285, ZEBPAY_ID, "ZRX", 0.00295, 0.00295, 5);
        ExchangeFees zebpayKNCFees = new ExchangeFees(286, ZEBPAY_ID, "KNC", 0.00295, 0.00295, 2);
        ExchangeFees zebpayGNTFees = new ExchangeFees(287, ZEBPAY_ID, "GNT", 0.00295, 0.00295, 10);
        ExchangeFees zebpayBATFees = new ExchangeFees(288, ZEBPAY_ID, "BAT", 0.00295, 0.00295, 10);
        ExchangeFees zebpayVENFees = new ExchangeFees(289, ZEBPAY_ID, "VEN", 0.00295, 0.00295, 1);
        ExchangeFees zebpayAEFees = new ExchangeFees(290, ZEBPAY_ID, "AE", 0.00295, 0.00295, 2);
        ExchangeFees zebpayIOSTFees = new ExchangeFees(291, ZEBPAY_ID, "IOST", 0.00295, 0.00295, 85);
        ExchangeFees zebpayCMTFees = new ExchangeFees(292, ZEBPAY_ID, "CMT", 0.00295, 0.00295, 12);
        ExchangeFees zebpayNCASHFees = new ExchangeFees(316, ZEBPAY_ID, "NCASH", 0.00295, 0.00295, 200);
        ...
        ExchangeFees coinomeBTGFees = new ExchangeFees(156, COINOME_ID, "BTG", 0.00354, 0.00354, 0.01);
        ExchangeFees coinomeXRPFees = new ExchangeFees(242, COINOME_ID, "XRP", 0.00354, 0.00354, 0.25);
        ExchangeFees coinomeETHFees = new ExchangeFees(260, COINOME_ID, "ETH", 0.00354, 0.00354, 0.003);
        ...
        ExchangeFees coindeltaETHFees = new ExchangeFees(17, COINDELTA_ID, "ETH", 0.003, 0.003, 0.001);
        ...
        ExchangeFees coindeltaKNCFees = new ExchangeFees(140, COINDELTA_ID, "KNC", 0.003, 0.003, 2);
        ExchangeFees coindeltaEOSFees = new ExchangeFees(141, COINDELTA_ID, "EOS", 0.003, 0.003, 0.5);
        ExchangeFees coindeltaZECFees = new ExchangeFees(153, COINDELTA_ID, "ZEC", 0.003, 0.003, 0.005);
        ExchangeFees coindeltaNEOFees = new ExchangeFees(154, COINDELTA_ID, "NEO", 0.003, 0.003, 0);
        ExchangeFees coindeltaGASFees = new ExchangeFees(155, COINDELTA_ID, "GAS", 0.003, 0.003, 0);
        ExchangeFees coindeltaAIONFees = new ExchangeFees(164, COINDELTA_ID, "AION", 0.003, 0.003, 1);
        ExchangeFees coindeltaBATFees = new ExchangeFees(165, COINDELTA_ID, "BAT", 0.003, 0.003, 10);
        ExchangeFees coindeltaCNDFees = new ExchangeFees(166, COINDELTA_ID, "CND", 0.003, 0.003, 30);
        ExchangeFees coindeltaCVCFees = new ExchangeFees(167, COINDELTA_ID, "CVC", 0.003, 0.003, 10);
        ExchangeFees coindeltaMANAFees = new ExchangeFees(168, COINDELTA_ID, "MANA", 0.003, 0.003, 30);
        ExchangeFees coindeltaENGFees = new ExchangeFees(169, COINDELTA_ID, "ENG", 0.003, 0.003, 1.5);
        ExchangeFees coindeltaGNTFees = new ExchangeFees(170, COINDELTA_ID, "GNT", 0.003, 0.003, 10);
        ExchangeFees coindeltaICXFees = new ExchangeFees(171, COINDELTA_ID, "ICX", 0.003, 0.003, 1);
        ...
        ExchangeFees coindeltaACTFees = new ExchangeFees(236, COINDELTA_ID, "ACT", 0.003, 0.003, 1);
        ExchangeFees coindeltaDAIFees = new ExchangeFees(241, COINDELTA_ID, "DAI", 0.003, 0.003, 5);
        ExchangeFees coindeltaQKCFees = new ExchangeFees(281, COINDELTA_ID, "QKC", 0.003, 0.003, 20);
        ExchangeFees coindeltaKRMFees = new ExchangeFees(282, COINDELTA_ID, "KRM", 0.003, 0.003, 20);
        ExchangeFees coindeltaAEFees = new ExchangeFees(294, COINDELTA_ID, "AE", 0.003, 0.003, 1.2);
        ExchangeFees coindeltaTENFees = new ExchangeFees(296, COINDELTA_ID, "TEN", 0.003, 0.003, 10);
        ExchangeFees coindeltaSTXFees = new ExchangeFees(310, COINDELTA_ID, "STX", 0.003, 0.003, 10);
        ExchangeFees coindeltaHSTFees = new ExchangeFees(311, COINDELTA_ID, "HST", 0.003, 0.003, 10);

        ExchangeFees pocketBitsETHFees = new ExchangeFees(22, POCKETBITS_ID, "ETH", 10.0, 10.0, 0.002);
        ExchangeFees pocketBitsBTCFees = new ExchangeFees(23, POCKETBITS_ID, "BTC", 10.0, 0.0, 0.0003);
        ExchangeFees pocketBitsBCHFees = new ExchangeFees(24, POCKETBITS_ID, "BCH", 10.0, 10.0, 0.001);
        ExchangeFees pocketBitsLTCFees = new ExchangeFees(25, POCKETBITS_ID, "LTC", 10.0, 10.0, 0.01);
        ExchangeFees pocketBitsXRPFees = new ExchangeFees(26, POCKETBITS_ID, "XRP", 10.0, 10.0, 5);
        ExchangeFees pocketBitsDASHFees = new ExchangeFees(163, POCKETBITS_ID, "DASH", 10.0, 10.0, 0.002);
        ExchangeFees pocketBitsETCFees = new ExchangeFees(39, POCKETBITS_ID, "ETC", 10.0, 10.0, 0.01);
        ExchangeFees pocketBitsXMRFees = new ExchangeFees(40, POCKETBITS_ID, "XMR", 10.0, 10.0, 0.04);
        ExchangeFees pocketBitsNEOFees = new ExchangeFees(41, POCKETBITS_ID, "NEO", 10.0, 10.0, 0.025);
        ExchangeFees pocketBitsOMGFees = new ExchangeFees(42, POCKETBITS_ID, "OMG", 10.0, 10.0, 0.35);
        ExchangeFees pocketBitsZECFees = new ExchangeFees(43, POCKETBITS_ID, "ZEC", 10.0, 10.0, 0.005);
        ExchangeFees pocketBitsBTGFees = new ExchangeFees(51, POCKETBITS_ID, "BTG", 10.0, 10.0, 0.001);
        ExchangeFees pocketBitsDGBFees = new ExchangeFees(52, POCKETBITS_ID, "DGB", 10.0, 10.0, 0.2);
        ExchangeFees pocketBitsXLMFees = new ExchangeFees(53, POCKETBITS_ID, "XLM", 10.0, 10.0, 0.01);
        ExchangeFees pocketBitsSCFees = new ExchangeFees(54, POCKETBITS_ID, "SC", 10.0, 10.0, 0.1);
        ExchangeFees pocketBitsXVGFees = new ExchangeFees(55, POCKETBITS_ID, "XVG", 10.0, 10.0, 0.2);
        ExchangeFees pocketBitsVOXFees = new ExchangeFees(56, POCKETBITS_ID, "VOX", 10.0, 10.0, 0.1);
        ExchangeFees pocketBitsTRXFees = new ExchangeFees(109, POCKETBITS_ID, "TRX", 10.0, 10.0, 1);
        ExchangeFees pocketBitsZRXFees = new ExchangeFees(183, POCKETBITS_ID, "ZRX", 10.0, 10.0, 1);
        ExchangeFees pocketBitsREPFees = new ExchangeFees(184, POCKETBITS_ID, "REP", 10.0, 10.0, 0.1);
        ExchangeFees pocketBitsBATFees = new ExchangeFees(185, POCKETBITS_ID, "BAT", 10.0, 10.0, 10);
        ExchangeFees pocketBitsQTUMFees = new ExchangeFees(186, POCKETBITS_ID, "QTUM", 10.0, 10.0, 0.01);
        ExchangeFees pocketBitsADAFees = new ExchangeFees(187, POCKETBITS_ID, "ADA", 10.0, 10.0, 0.2);
        ExchangeFees pocketBitsDOGEFees = new ExchangeFees(188, POCKETBITS_ID, "DOGE", 10.0, 10.0, 2);
        ExchangeFees pocketBitsGNTFees = new ExchangeFees(189, POCKETBITS_ID, "GNT", 10.0, 10.0, 9);
        ExchangeFees pocketBitsSTORJFees = new ExchangeFees(190, POCKETBITS_ID, "STORJ", 10.0, 10.0, 3);
        ExchangeFees pocketBitsUBQFees = new ExchangeFees(191, POCKETBITS_ID, "UBQ", 10.0, 10.0, 0.01);
        ...
        ExchangeFees bitBnsTRXFees = new ExchangeFees(110, BITBNS_ID, "TRX", 0.0025, 0.0025, 60);
        ...
        ExchangeFees bitBnsICXFees = new ExchangeFees(149, BITBNS_ID, "ICX", 0.0025, 0.0025, 1.5);
        ExchangeFees bitBnsVENFees = new ExchangeFees(150, BITBNS_ID, "VEN", 0.0025, 0.0025, 1);
        ...
        ExchangeFees oxybitFees1 = new ExchangeFees(62, OXYBIT_ID, "BTC", 10.0, 10.0, 0.0005);
        ExchangeFees oxybitFees2 = new ExchangeFees(63, OXYBIT_ID, "ETH", 10.0, 10.0, 0.005);
        ExchangeFees oxybitFees3 = new ExchangeFees(64, OXYBIT_ID, "XRP", 10.0, 10.0, 0.5);
        ExchangeFees oxybitFees4 = new ExchangeFees(65, OXYBIT_ID, "LTC", 10.0, 10.0, 0.01);
        ExchangeFees oxybitFees5 = new ExchangeFees(66, OXYBIT_ID, "BCH", 10.0, 10.0, 0.001);
        ExchangeFees oxybitFees6 = new ExchangeFees(67, OXYBIT_ID, "XLM", 10.0, 10.0, 1);
        ExchangeFees oxybitFees7 = new ExchangeFees(68, OXYBIT_ID, "EOS", 10.0, 10.0, 0.1);
        ExchangeFees oxybitFees8 = new ExchangeFees(69, OXYBIT_ID, "DASH", 10.0, 10.0, 0.01);
        ExchangeFees oxybitFees9 = new ExchangeFees(70, OXYBIT_ID, "XMR", 10.0, 10.0, 0.06);
        ExchangeFees oxybitFees10 = new ExchangeFees(71, OXYBIT_ID, "TRX", 10.0, 10.0, 125);
        ExchangeFees oxybitFees11 = new ExchangeFees(72, OXYBIT_ID, "VET", 10.0, 10.0, 3);
        ExchangeFees oxybitFees12 = new ExchangeFees(73, OXYBIT_ID, "OMG", 10.0, 10.0, 1);
        ExchangeFees oxybitFees13 = new ExchangeFees(74, OXYBIT_ID, "NANO", 10.0, 10.0, 1);
        ExchangeFees oxybitFees14 = new ExchangeFees(75, OXYBIT_ID, "SNT", 10.0, 10.0, 30);
        ExchangeFees oxybitFees15 = new ExchangeFees(76, OXYBIT_ID, "REP", 10.0, 10.0, 0.1);
        ExchangeFees oxybitFees16 = new ExchangeFees(77, OXYBIT_ID, "ZRX", 10.0, 10.0, 18.1);
        ExchangeFees oxybitFees17 = new ExchangeFees(78, OXYBIT_ID, "BAT", 10.0, 10.0, 35);
        ExchangeFees oxybitFees18 = new ExchangeFees(79, OXYBIT_ID, "GNT", 10.0, 10.0, 35);
        ExchangeFees oxybitFees19 = new ExchangeFees(80, OXYBIT_ID, "KNC", 10.0, 10.0, 3);
        ExchangeFees oxybitFees20 = new ExchangeFees(81, OXYBIT_ID, "FUN", 10.0, 10.0, 120);
        ExchangeFees oxybitFees21 = new ExchangeFees(82, OXYBIT_ID, "SALT", 10.0, 10.0, 2);
        ExchangeFees oxybitFees22 = new ExchangeFees(83, OXYBIT_ID, "BNT", 10.0, 10.0, 3);
        ExchangeFees oxybitFees23 = new ExchangeFees(84, OXYBIT_ID, "REQ", 10.0, 10.0, 30);
        ExchangeFees oxybitFees24 = new ExchangeFees(85, OXYBIT_ID, "SAN", 10.0, 10.0, 3);
        ExchangeFees oxybitFees25 = new ExchangeFees(86, OXYBIT_ID, "GNO", 10.0, 10.0, 0.01);
        ExchangeFees oxybitFees26 = new ExchangeFees(87, OXYBIT_ID, "ICN", 10.0, 10.0, 3);
        ExchangeFees oxybitFees27 = new ExchangeFees(88, OXYBIT_ID, "POE", 10.0, 10.0, 120);
        ExchangeFees oxybitFees28 = new ExchangeFees(89, OXYBIT_ID, "CVC", 10.0, 10.0, 30);
        ExchangeFees oxybitFees29 = new ExchangeFees(90, OXYBIT_ID, "STORJ", 10.0, 10.0, 3);
        ExchangeFees oxybitFees30 = new ExchangeFees(91, OXYBIT_ID, "MCO", 10.0, 10.0, 1);
        ExchangeFees oxybitFees31 = new ExchangeFees(92, OXYBIT_ID, "ANT", 10.0, 10.0, 3);
        ExchangeFees oxybitFees32 = new ExchangeFees(102, OXYBIT_ID, "NEO", 10.0, 10.0, 0.01);
        ExchangeFees oxybitFees33 = new ExchangeFees(103, OXYBIT_ID, "GAS", 10.0, 10.0, 0.1);
        ...
        ExchangeFees wazirxFees18 = new ExchangeFees(225, WAZIRX_ID, "ICX", 0.00295, 0.00295, 0.5);
        ...
        ExchangeFees koinok1 = new ExchangeFees(243, KOINOK_ID, "BTC", 0.0015, 0.001, 0.0005);
        ExchangeFees koinok2 = new ExchangeFees(244, KOINOK_ID, "CAS", 0.0015, 0.001, 50);
        ExchangeFees koinok3 = new ExchangeFees(245, KOINOK_ID, "CVC", 0.0015, 0.001, 5);
        ExchangeFees koinok4 = new ExchangeFees(246, KOINOK_ID, "ETH", 0.0015, 0.001, 0.003);
        ExchangeFees koinok5 = new ExchangeFees(247, KOINOK_ID, "GAS", 0.0015, 0.001, 0.001);
        ExchangeFees koinok6 = new ExchangeFees(248, KOINOK_ID, "ICX", 0.0015, 0.001, 0.5);
        ExchangeFees koinok7 = new ExchangeFees(249, KOINOK_ID, "NEO", 0.0015, 0.001, 0);
        ExchangeFees koinok8 = new ExchangeFees(250, KOINOK_ID, "OMG", 0.0015, 0.001, 0.2);
        ExchangeFees koinok9 = new ExchangeFees(251, KOINOK_ID, "RDD", 0.0015, 0.001, 5);
        ExchangeFees koinok10 = new ExchangeFees(252, KOINOK_ID, "TRX", 0.0015, 0.001, 50);
        ExchangeFees koinok11 = new ExchangeFees(253, KOINOK_ID, "VEN", 0.0015, 0.001, 0.5);
        ExchangeFees koinok12 = new ExchangeFees(254, KOINOK_ID, "VIB", 0.0015, 0.001, 10);
        ExchangeFees koinok13 = new ExchangeFees(255, KOINOK_ID, "XDCE", 0.0015, 0.001, 50);
        ExchangeFees koinok14 = new ExchangeFees(256, KOINOK_ID, "XRP", 0.0015, 0.001, 0.1);
        ExchangeFees koinok15 = new ExchangeFees(257, KOINOK_ID, "ZIL", 0.0015, 0.001, 15);
        ExchangeFees koinok16 = new ExchangeFees(258, KOINOK_ID, "ZRX", 0.0015, 0.001, 1);
        ExchangeFees koinok17 = new ExchangeFees(307, KOINOK_ID, "GRS", 0.0015, 0.001, 0.2);
        ExchangeFees koinok18 = new ExchangeFees(308, KOINOK_ID, "KEY", 0.0015, 0.001, 100);
        ExchangeFees koinok19 = new ExchangeFees(309, KOINOK_ID, "LWF", 0.0015, 0.001, 0.5);
