...
public class SplashInteractor extends BaseInteractor
    ...
    public Observable<List<Long>> saveDefaultExchangeFees() {
        ...
        ExchangeFees koinexTRXFees = new ExchangeFees(111, KOINEX_ID, "TRX", 0.1, 0.1, 60);
        ...
        ExchangeFees zebpayBTCFees = new ExchangeFees(8, ZEBPAY_ID, "BTC", 0.00295, 0.1, 0.0005);
        ExchangeFees zebpayBCHFees = new ExchangeFees(28, ZEBPAY_ID, "BCH", 0.00295, 0.1, 0.001);
        ExchangeFees zebpayLTCFees = new ExchangeFees(49, ZEBPAY_ID, "LTC", 0.00295, 0.1, 0.006);
        ExchangeFees zebpayXRPFees = new ExchangeFees(50, ZEBPAY_ID, "XRP", 0.00295, 0.1, 0.25);
        ExchangeFees zebpayETHFees = new ExchangeFees(60, ZEBPAY_ID, "ETH", 0.00295, 0.1, 0.01);
        ExchangeFees zebpayEOSFees = new ExchangeFees(194, ZEBPAY_ID, "EOS", 0.00295, 0.1, 0.4);
        ExchangeFees zebpayOMGFees = new ExchangeFees(195, ZEBPAY_ID, "OMG", 0.00295, 0.1, 0.2);
        ExchangeFees zebpayTRXFees = new ExchangeFees(199, ZEBPAY_ID, "TRX", 0.00295, 0.1, 60);
        ExchangeFees zebpayZILFees = new ExchangeFees(283, ZEBPAY_ID, "ZIL", 0.00295, 0.1, 2);
        ExchangeFees zebpayREPFees = new ExchangeFees(284, ZEBPAY_ID, "REP", 0.00295, 0.1, 0.05);
        ExchangeFees zebpayZRXFees = new ExchangeFees(285, ZEBPAY_ID, "ZRX", 0.00295, 0.1, 5);
        ExchangeFees zebpayKNCFees = new ExchangeFees(286, ZEBPAY_ID, "KNC", 0.00295, 0.1, 2);
        ExchangeFees zebpayGNTFees = new ExchangeFees(287, ZEBPAY_ID, "GNT", 0.00295, 0.1, 10);
        ExchangeFees zebpayBATFees = new ExchangeFees(288, ZEBPAY_ID, "BAT", 0.00295, 0.1, 10);
        ExchangeFees zebpayVENFees = new ExchangeFees(289, ZEBPAY_ID, "VEN", 0.00295, 0.1, 1);
        ExchangeFees zebpayAEFees = new ExchangeFees(290, ZEBPAY_ID, "AE", 0.00295, 0.1, 2);
        ExchangeFees zebpayIOSTFees = new ExchangeFees(291, ZEBPAY_ID, "IOST", 0.00295, 0.1, 85);
        ExchangeFees zebpayCMTFees = new ExchangeFees(292, ZEBPAY_ID, "CMT", 0.00295, 0.1, 12);
        ExchangeFees zebpayNCASHFees = new ExchangeFees(316, ZEBPAY_ID, "NCASH", 0.00295, 0.1, 200);
        ...
        ExchangeFees coindeltaICXFees = new ExchangeFees(171, COINDELTA_ID, "ICX", 0.003, 0.003, 0.1);
        ...
        ExchangeFees bitBnsTRXFees = new ExchangeFees(110, BITBNS_ID, "TRX", 0.1, 0.1, 60);
        ...
        ExchangeFees bitBnsEOSFees = new ExchangeFees(142, BITBNS_ID, "EOS", 0.1, 0.0025, 0.5);
        ...
        ExchangeFees wazirxFees4 = new ExchangeFees(179, WAZIRX_ID, "TRX", 0.1, 0.1, 60);
